...
import com.gurureddy.chattingapp.adapters.UsersAdapter;
import com.gurureddy.chattingapp.databinding.ActivityUserBinding;
import com.gurureddy.chattingapp.listeners.UserListener;
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if(task.isSuccessful() && task.getResult() !=null){
                        ...
                        for (QueryDocumentSnapshot queryDocumentSnapshot: task.getResult()){
                            ...
                            User user = new User();
                            user.dateTime=queryDocumentSnapshot.getString(Constants.KEY_TIMESTAMP);
