...
import com.gurureddy.chattingapp.databinding.ItemContainerRecentConversionBinding;
...
public class RecentConversionsAdapter extends RecyclerView.Adapter<RecentConversionsAdapter.ConversionViewHolder> {
    ...
    class ConversionViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage) {
            binding.imageProfile1.setImageBitmap(getConversionImage(chatMessage.conversionImage));
    ...
    public Bitmap getConversionImage(String encodeImage){
